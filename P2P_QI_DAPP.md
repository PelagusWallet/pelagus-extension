...
The abandonment change in this branch is intentionally narrow. It routes the
existing `qi_releaseReceiveAddressReservation` operation through an explicit
Pelagus confirmation window. It does not change the keyring, encrypted vault,
wallet import, seed recovery, Qi change selection, mining addresses, manual Qi
sends, aggregation, or conversion.
