 ...
 * @param passwordOrSaltedKey A user-supplied password to encrypt the object, or a cached
 *        salted key
 ...
 * @param passwordOrSaltedKey A user-supplied password to decrypt the vault, or a cached
 *        salted key
