...
export const PORT_HEALTH_CHECK_INTERVAL_IN_MILLISECONDS = 60000
...
export const PELAGUS_WINDOW_PROVIDER_ICON_URL = "https://pelaguswallet.io/docs/img/PelagusLogoSquare.png" // TODO icon for pelagus provider
